...
Built with Next.js, React, TypeScript, and Three.js, the frontend sends 15 sensor readings to a Python backend every 15 seconds and displays the returned vehicle assessment.
